  ...
  return (
    <div className="admin-sidebar-container">
      ...
      <div className="admin-sidebar-content-container">
        <div className="sidebar-btn overview-btn">
          <svg
        ...
        <div className="sidebar-btn elections-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
        ...
        <div className="sidebar-btn user-management-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
        ...
        <div className="sidebar-btn vote-history-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
        ...
        <div className="sidebar-btn results-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
